...
public class CreateProductCommandInterceptor implements MessageDispatchInterceptor<CommandMessage<?>> {
	...
	private final ProductLookupRepsoitory lookupRepsoitory;
	
	public CreateProductCommandInterceptor(ProductLookupRepsoitory productLookupRepsoitory) {
		this.lookupRepsoitory = productLookupRepsoitory;
...
//				}
			ProductLookupEntity productLookupEntity =	lookupRepsoitory.findByProductIdorTitle(createProductCommand.getProductId(), createProductCommand.getTitle());
